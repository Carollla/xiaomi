...
from visual_detect_yellow import YellowDetector
from qrcode_scan import RGBNode
import signal
import sys
import time
...
def main():
    ...
    try:
        ...
        print('初始化二维码检测节点...')
        qrcode_detector = RGBNode()
        executor.add_node(qrcode_detector)
        nodes.append(qrcode_detector)
        print(f'- 已启动节点: {qrcode_detector.get_name()}')
